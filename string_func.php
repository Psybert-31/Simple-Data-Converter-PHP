                ...
                <tbody>
                    <?php
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $studentno = strtoupper($row['studentno']);
                                ...
                                <a href="delete.php?deleteid=' . $id . '"><button onclick="myFunction()" id="btnDelete" class="btn btn-danger text-light"><i class="bi bi-trash-fill"></i> DELETE</button></a>
                                </td>
                                </tr>
                                ';
                        }
                ...
                <tbody>
                    <?php
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $studentno = strrev($row['studentno']);
                                    $email = strrev($row['email']);
                                    $age = $row['age'];
                                    $section = strrev($row['section']);
                                    echo '
...
>                    </tr>
            ...
            <tbody>
                <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                                $id = $row['id'];
                                $name = strtr($row['name'], "o", "a");
                                $studentno = strtr($row['studentno'], "o", "a");
                                $email = strtr($row['email'], "o", "a");
                                $age = $row['age'];
                                $section = strtr($row['section'],"o", "a");
                                echo '
